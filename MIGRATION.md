...
- Supplemental request metadata is best-effort and content-free. Every write path shares one transactional capacity policy: each row is capped at 2 KiB and the table is bounded to 24 hours, 32,768 rows, and 64 MiB, with cleanup limited to 512 rows and 512 KiB per call and capacity pressure reported as a drop outcome.
